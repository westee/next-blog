...
var User = (_dec = (0, _typeorm.Entity)('users'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('varchar'), _dec4 = (0, _typeorm.Column)({
  type: 'varchar',
  select: false
}), _dec5 = (0, _typeorm.OneToMany)(function (type) {
  ...
  return post.author;
}), _dec7 = (0, _typeorm.UpdateDateColumn)(), _dec8 = (0, _typeorm.UpdateDateColumn)(), _dec(_class = (_class2 = function User() {
  ...
  (0, _initializerDefineProperty2["default"])(this, "posts", _descriptor5, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "posts", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
